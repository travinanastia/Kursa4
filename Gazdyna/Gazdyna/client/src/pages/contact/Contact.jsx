...
const Contact = () => {
  ...
  return (
    <section className="box flex flex-col-reverse md:flex-row w-full gap-12 md:gap-6 justify-center items-center">
      <div className="basis-1/2 lg:basis-1/3 bg-gradient-to-t from-pink-100 via-pink-300 to-pink-400 rounded-2xl px-10 py-10 h-full w-[100%] sm:w-[80%] md:w-[100%] text-center md:text-start">
        <h3 className="font-bold text-xl mb-6">Get in touch</h3>
        <div className="mb-5 flex flex-col gap-1">
          <h4 className="font-bold">Chat with us</h4>
          <p>Our team is here to help</p>
          <a
            href="mailto:Gazdyna@gmail.com"
